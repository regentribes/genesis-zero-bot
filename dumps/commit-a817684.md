=== COMMIT: a817684 ===
a817684 refactor: add docs structure - ADR/RFP/PRD folders, specs, prompts/iterations
...
# PROMPT.md — Mythogen AME Design Iterations

This folder contains design iterations for the Affinity Mapping Engine.

## Format Convention

Each iteration is a `.md` file with:
- **Date**: ISO 8601 format
- **System**: Which coding system generated it (Claude Code, Codex, etc.)
- **Focus**: What the iteration addresses
- **Output**: The design artifact

## Iteration Naming

Format: `YYYY-MM-DD-{system}-{focus}.md`

Example: `2026-03-29-claude-architecture-v1.md`

## Running Iterations

When tasked with designing a component:
1. Create iteration file in this folder
2. Work in isolation
3. Compare with previous iterations before finalizing
4. Move approved designs to `docs/` folder

## Reference

See [Ralph Orchestrator PROMPT.md](https://github.com/mikeyobrien/ralph-orchestrator) for agent coordination patterns.
